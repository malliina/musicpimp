...
# chkconfig: 345 80 20
# description: App
# processname: musicpimp
# pidfile: /var/run/musicpimp.pid
#
### BEGIN INIT INFO
# Provides:          musicpimp
...
# Default-Stop:      0 1 6
# Short-Description: Start musicpimp at boot time
# Description:       Manages the services needed to run musicpimp
### END INIT INFO
#
# Startup script for musicpimp under *nix systems (it works under NT/cygwin too).
