...
# chkconfig: 345 80 20
# description: App
# processname: musicmeta
# pidfile: /var/run/musicmeta.pid
#
### BEGIN INIT INFO
# Provides:          musicmeta
...
# Default-Stop:      0 1 6
# Short-Description: Start musicmeta at boot time
# Description:       Manages the services needed to run musicmeta
### END INIT INFO
#
# Startup script for musicmeta under *nix systems (it works under NT/cygwin too).
